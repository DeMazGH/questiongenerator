...
class JavaQuestionServiceTest {
    ...
    void shouldReturnCorrectQuestionInMethodAdd() {
        ...
        assertEquals(OBJ_QUESTION_1, actual);
    }

    @Test
    void shouldReturnQuestionInMethodAdd() {
        Question actual = out.add(OBJ_QUESTION_2);
        assertEquals(OBJ_QUESTION_2, actual);
    }
    ...
    void shouldReturnTrueInMethodAdd() {
        ...
        assertTrue(out.getAll().contains(OBJ_QUESTION_1));
    ...
    void shouldReturnQuestionInMethodRemove() {
        out.add(OBJ_QUESTION_2);
        Question actual = out.remove(OBJ_QUESTION_2);
        assertEquals(OBJ_QUESTION_2, actual);
    }
